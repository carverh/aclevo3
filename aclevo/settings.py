...
ROOT_URLCONF = 'aclevo.urls'



WSGI_APPLICATION = 'aclevo.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'aclevo', 'static'),
)
SITE_ID = 1
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'aclevo', 'templates'),],
        'OPTIONS': {
            'context_processors': [
...
BLOG_IMAGE_THUMBNAIL_SIZE = {'size': '200x200', 'crop': True, 'upscale': True}
